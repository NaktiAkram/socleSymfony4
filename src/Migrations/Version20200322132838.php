 ...
 */
final class Version20200322132838 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Kubernetes CHANGE labels labels LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Kubernetes CHANGE labels labels LONGTEXT CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\'');
        $this->addSql('ALTER TABLE NFS CHANGE pv_id pv_id INT DEFAULT NULL');
