 ...
 */
final class Version20200321203255 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Kubernetes DROP value_id, CHANGE labels labels LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
        ...
        $this->addSql('ALTER TABLE EndPoints CHANGE labels labels LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE port port VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `Values` (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE EndPoints CHANGE labels labels LONGTEXT CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\', CHANGE port port INT NOT NULL');
        $this->addSql('ALTER TABLE Execute CHANGE containers_id containers_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE GlusterFS CHANGE pv_id pv_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE HostPath CHANGE pv_id pv_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE Items CHANGE configMapVolumes_id configMapVolumes_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE Kubernetes ADD value_id INT DEFAULT NULL, CHANGE labels labels LONGTEXT CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\'');
